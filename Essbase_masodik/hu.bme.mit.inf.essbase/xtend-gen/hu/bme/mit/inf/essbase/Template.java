...
public class Template {
  public CharSequence getLatexContent(final long ktgh, final long szolg, final long gepj, final long ugyf) {
    ...
    _builder.newLine();
    _builder.append("width=220pt,");
    _builder.newLine();
    _builder.append("height=220pt,");
    _builder.newLine();
    _builder.append("grid=major,");
    _builder.newLine();
    _builder.append("z buffer=sort,");
    _builder.newLine();
    _builder.append("xmin=-1,xmax=9,");
    _builder.newLine();
    _builder.append("ymin=-1,ymax=9,");
    _builder.newLine();
    _builder.append("zmin=-1,zmax=9,");
    _builder.newLine();
    _builder.append("enlargelimits=upper,");
    _builder.newLine();
    _builder.append("xtick={-1,1,...,19},");
    _builder.newLine();
    _builder.append("ytick={-1,1,...,19},");
    _builder.newLine();
    _builder.append("ztick={-1,1,...,19},");
    _builder.newLine();

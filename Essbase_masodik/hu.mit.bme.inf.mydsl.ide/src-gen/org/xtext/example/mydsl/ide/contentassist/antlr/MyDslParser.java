		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getQueryMDXAccess().getGroup(), "rule__QueryMDX__Group__0");
					...
					put(grammarAccess.getMDXFunctionAccess().getValueAssignment(), "rule__MDXFunction__ValueAssignment");
					put(grammarAccess.getQueryMDXAccess().getNameAssignment_0(), "rule__QueryMDX__NameAssignment_0");
					put(grammarAccess.getQueryMDXAccess().getRAssignment_6(), "rule__QueryMDX__RAssignment_6");
					put(grammarAccess.getQueryMDXAccess().getFrAssignment_8(), "rule__QueryMDX__FrAssignment_8");
					put(grammarAccess.getQueryMDXAccess().getCAssignment_12(), "rule__QueryMDX__CAssignment_12");
					put(grammarAccess.getQueryMDXAccess().getFcAssignment_14(), "rule__QueryMDX__FcAssignment_14");
					put(grammarAccess.getMDXRowsAccess().getValueAssignment(), "rule__MDXRows__ValueAssignment");
					put(grammarAccess.getMDXCOlumnsAccess().getValueAssignment(), "rule__MDXCOlumns__ValueAssignment");

 ...
 * @generated
 */
public class Essbase_modelPackageImpl extends EPackageImpl implements Essbase_modelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see essbase_model.Essbase_modelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Essbase_modelPackageImpl() {
		super(eNS_URI, Essbase_modelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Essbase_modelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Essbase_modelPackage init() {
		if (isInited) return (Essbase_modelPackage)EPackage.Registry.INSTANCE.getEPackage(Essbase_modelPackage.eNS_URI);

		// Obtain or create and register package
		Essbase_modelPackageImpl theEssbase_modelPackage = (Essbase_modelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Essbase_modelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Essbase_modelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theEssbase_modelPackage.createPackageContents();

		// Initialize created meta-data
		theEssbase_modelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEssbase_modelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Essbase_modelPackage.eNS_URI, theEssbase_modelPackage);
		return theEssbase_modelPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getDimension_Group() {
	 ...
	 * @generated
	 */
	public EReference getDimension_Member() {
	...
	public void createPackageContents() {
		...
		createEReference(dimensionEClass, DIMENSION__GROUP);
		createEReference(dimensionEClass, DIMENSION__MEMBER);
	...
	public void initializePackageContents() {
		...
		initEReference(getDimension_Group(), this.getGroup(), null, "group", null, 0, -1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDimension_Member(), this.getMember(), null, "member", null, 0, -1, Dimension.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGroup_Member(), this.getMember(), null, "member", null, 0, -1, Group.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
